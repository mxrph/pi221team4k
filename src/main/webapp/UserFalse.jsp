...
<div class = "font">
   <div class = "topright">
    ...
    <div class="a"><a href="komanda.jsp" role="button" class ="knopka">О нас</a>
          <a type="submit" href="${pageContext.request.contextPath}/docs/ExplNote.pdf" class="knopka" >Пояснительная записка</a>
     <a type="submit" href="${pageContext.request.contextPath}/docs/TechSpec.pdf" class="knopka" >Техническое задание</a>
     <a type="submit" href="${pageContext.request.contextPath}/docs/UserGuide.pdf" class="knopka" >Руководство пользователя</a><br><br><br>
              </div></div></div>
<h1>Калькулятор потребительского кредита</h1>
  ...
  <div class="radio">
    <label class="custom-radio">
      <input checked type="radio" name="dosr" value="-1">
      <span>Нет</span>
    </label>
  </div>
